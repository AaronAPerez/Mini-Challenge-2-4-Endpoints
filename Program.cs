...
app.MapGet("/mathSum", (int a = 1, int b = 2) =>
{
    return $"{a} + {b} = {a+b}";
});


app.MapGet("/nameWakeUpTime", (string name = "User", string time = "userInput", string amPm = "amPm") =>
{
    return $"Hello {name}, you woke up at {time}{amPm}, Great Job!!!!!";
});


app.MapGet("/compareNumbers", (int a = 1, int b = 2) =>
{
    if (a > b){
